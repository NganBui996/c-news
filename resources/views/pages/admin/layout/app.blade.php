...
<head>
  ...
  <title>C-NEWS | C-NEWS </title>

  <!-- Font Awesome Icons -->
  <link rel="stylesheet" href={{ asset("theme/admin/plugins/font-awesome/css/font-awesome.min.css") }}>
  <!-- IonIcons -->
...
<div class="wrapper">
  <!-- Navbar -->
  @include('pages.admin.layout.includes.navbar')
  <!-- /.navbar -->
  <!-- Main Sidebar Container -->
  @include('pages.admin.layout.includes.sidebar')
  ...
  <div class="content-wrapper">
    ...
    <img src={{ asset("theme/admin/dist/img/photo1.png") }} width="150" height="150">
    <!-- /.content -->
  </div>
  <!-- /.content-wrapper -->
...
<script src={{ asset("theme/admin/dist/js/pages/dashboard3.js") }}></script>
</body>
</html>
